...
background_image_path =  "C:\\Users\\User\\Desktop\\music.jpg"
...
# Title Label
title_label = ttk.Label(window, text="Music Classification model", font=("Georgia", 25, "bold"), foreground="darkorange", background='navy')

title_label.grid(row=0, column=0, columnspan=2, pady=(20, 10))

subtitle_label = ttk.Label(window, text="Welcome to your Ai model!", font=("Times New Roman", 14), foreground="black",background='orangered')
...
training_data_path = "C:\\Users\\User\\Downloads\\Training-data.csv"
...
def cal_accuracy(y_test, y_pred):
    ...
    subtitle_label = ttk.Label(window, text=("Accuracy =", accuracy_score(y_test, y_pred) * 100),font=("Times New Roman", 12), background="darkblue", foreground="white")
    subtitle_label.grid(row=6, column=0, columnspan=1, pady=(0, 20))
# Function to calculate recall
def cal_recall(y_test, y_pred):
    recall_macro = recall_score(y_test, y_pred, average='macro')
    recall_micro = recall_score(y_test, y_pred, average='micro')
    subtitle_label = ttk.Label(window, text=("Recall  =", recall_macro * 100), font=("Times New Roman", 12),background="darkblue", foreground="white")
...
def cal_precision(y_test, y_pred):
    ...
    subtitle_label = ttk.Label(window, text=("Precision =", precision_percent), font=("Times New Roman", 12),background="darkblue", foreground="white")
...
liked_songs_label = ttk.Label(window, text="Songs liked by the user:", font=("Times New Roman", 14),background="darkorange", foreground="black")
...
subtitle_label = ttk.Label(window, text="Performance Evaluation For the Neural Network Model",font=("Times New Roman", 15), background="darkorange", foreground="navy")
subtitle_label.grid(row=9, column=0, columnspan=1, pady=(0, 20))

##################################################################################################################################

# Load the data Neural Network
file_path2 = "C:\\Users\\User\\Downloads\\Training-data.csv"
...
subtitle_label = ttk.Label(window, text=("Accuracy =", accuracy_score(y_test1, y_pred1) * 100), font=("Times New Roman", 12), background="darkblue", foreground="white")
...
subtitle_label = ttk.Label(window, text=("Recall  =", recall1 * 100.0), font=("Times New Roman", 12),background="darkblue", foreground="white")
...
subtitle_label = ttk.Label(window, text=("Precision =", precision1 * 100.0), font=("Times New Roman", 12),background="darkblue", foreground="white")
...
entry_type = ttk.Combobox(window2,values=["Romantic", "Rock", "Jazz", "Ballads", "Folk", "Country", "Classical", "Hip Hop"])
...
entry_release_year = ttk.Combobox(window2,values=["1999", "2000", "2002", "2005", "2012", "2014", "2017", "2018", "2019","2021", "2020", "2023"])
